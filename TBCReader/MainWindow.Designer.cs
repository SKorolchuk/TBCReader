namespace TBCReader
{
    partial class MainWindow
    {
        ...
        private void InitializeComponent()
        {
			...
			this.GoToNewsBtn = new System.Windows.Forms.Button();
			...
			this.FeedContent = new System.Windows.Forms.WebBrowser();
			...
			// GoToNewsBtn
			// 
			this.GoToNewsBtn.Location = new System.Drawing.Point(237, 317);
			this.GoToNewsBtn.Name = "GoToNewsBtn";
			this.GoToNewsBtn.Size = new System.Drawing.Size(101, 23);
			this.GoToNewsBtn.TabIndex = 6;
			this.GoToNewsBtn.Text = "Go to Full News";
			this.GoToNewsBtn.UseVisualStyleBackColor = true;
			this.GoToNewsBtn.Click += new System.EventHandler(this.GoToNewsBtn_Click);
			// 
			// AddChannelBtn
			// 
			...
			this.RemoveChannelBtn.Click += new System.EventHandler(this.RemoveChannel);
			// 
			// label1
			// 
			...
			// FeedContent
			// 
			this.FeedContent.Location = new System.Drawing.Point(239, 138);
			this.FeedContent.MinimumSize = new System.Drawing.Size(20, 20);
			this.FeedContent.Name = "FeedContent";
			this.FeedContent.Size = new System.Drawing.Size(520, 173);
			this.FeedContent.TabIndex = 16;
			// 
			...
			this.Controls.Add(this.FeedContent);
			...
			this.Controls.Add(this.GoToNewsBtn);
        ...
        private System.Windows.Forms.Button GoToNewsBtn;
        ...
        private System.Windows.Forms.Label Title;
				...
				private System.Windows.Forms.WebBrowser FeedContent;
